...
public class NightFillDropCarton {
	...
	@JsonProperty("A7YUV5W359XPXRN8EPAHA0FZ0J")
	private String noOfCartons;
	
	@JsonProperty("A7YUV5W359XPXRN8EPAHA0FZ0J_F")
	private String noOfCartonsFormatted;
	
	
	@JsonProperty("A7YUV5W359XPXRN8EPAHAXLXQB")
	private String cartonRate;
	
	@JsonProperty("A7YUV5W359XPXRN8EPAHAXLXQB_F")
	private String cartonRateFormatted;
	
	@JsonProperty("A7YUV5W359XPXRQHFV6CIMDP8H")
	private String noOfHours;

	@JsonProperty("A7YUV5W359XPXRQHFV6CIMDP8H_F")
	 ...
	 * @param wareHouseName
	 */
	public NightFillDropCarton(@JsonProperty("ID") String id,@JsonProperty("TotaledProperties") String totalProperties,
			@JsonProperty("RDEPT") String departmentNumber,@JsonProperty("RDEPT_T") String departmentName,@JsonProperty("A7YUV5W359XPXRN8EPAHA0FZ0J") String noOfCartons,
			@JsonProperty("A7YUV5W359XPXRN8EPAHA0FZ0J_F") String noOfCartonsFormatted,@JsonProperty("A7YUV5W359XPXRN8EPAHAXLXQB") String cartonRate,
			@JsonProperty("A7YUV5W359XPXRN8EPAHAXLXQB_F") String cartonRateFormatted,@JsonProperty("A7YUV5W359XPXRQHFV6CIMDP8H") String noOfHours,
			@JsonProperty("A7YUV5W359XPXRQHFV6CIMDP8H_F") String noOfHoursFormatted,@JsonProperty("A0SUPP_PLANT") String wareHouseNumber,
