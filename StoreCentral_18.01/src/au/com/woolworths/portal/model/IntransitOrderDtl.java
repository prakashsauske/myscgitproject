...
public class IntransitOrderDtl {
	 ...
	 */
	@JsonCreator
	public IntransitOrderDtl(@JsonProperty("delivery_date") String deliveryDate,@JsonProperty("intransit_qty") String intransitQty,
