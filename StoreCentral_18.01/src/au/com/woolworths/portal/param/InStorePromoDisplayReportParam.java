...
public class InStorePromoDisplayReportParam {
	...
	public String getArticleNo_W() {
		return articleNo_W;
	}

	public void setArticleNo_W(String articleNo_W) {
		this.articleNo_W = articleNo_W;
	}
