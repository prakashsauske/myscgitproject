...
public class StockAdjReportParam {
	@JsonProperty("reportResult")
	private ArrayList<StockAdjReportResult> resultList;

	@JsonProperty("reportResultMPLFacings")
	private ArrayList<StockAdjReportMPLFacingsResult> resultListMPLFacings;
	...
	public ArrayList<StockAdjReportResult> getResultList() {
		return resultList;
	}

	public void setResultList(ArrayList<StockAdjReportResult> resultList) {
	...
	public ArrayList<StockAdjReportMPLFacingsResult> getResultListMPLFacings() {
		return resultListMPLFacings;
	}

	public void setResultListMPLFacings(
			ArrayList<StockAdjReportMPLFacingsResult> resultListMPLFacings) {
		this.resultListMPLFacings = resultListMPLFacings;
	}
