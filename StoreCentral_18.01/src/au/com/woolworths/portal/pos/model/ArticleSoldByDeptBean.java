...
public class ArticleSoldByDeptBean implements Serializable {
	/**
	 * 
	 */
	...
	@JsonProperty("A7YUV5W359XPW4P6Z38R67E9Z7")
	public void setTotal2(String total) {
		setTotal( total);
	}
	private String total;

	@JsonProperty("B0ZI8KYVSWSJL77J0SNP582KK")
	public void setQuantity2(String quantity) {
		setQuantity( quantity);
	}
	private String quantity;

	@JsonProperty("B0ZI8KYVSWSJL77J0SNP582KK_F")
	...
	public void add(ArticleSoldByDeptBean obj) {
	...
	public boolean equals(Object obj) {
		...
		if(obj!=null && obj instanceof ArticleSoldByDeptBean) {
			ArticleSoldByDeptBean tmpObj = (ArticleSoldByDeptBean) obj;
