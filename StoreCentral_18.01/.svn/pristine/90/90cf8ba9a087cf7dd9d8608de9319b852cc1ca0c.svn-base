...
function tblReport(table_name,table_title,data){
	...
	this.option = 'build';
	this.key = [ 'article_no','article_desc', 'om', 'soo', 'sit', 'soh','mpl' ];
	this.table_name = report_name;
	this.table_title = '';
	this.table_class = ' ContentTable actionRows';
	this.header_tr_class = 'collapsed';
	this.header_name = {article_no : 'Article#',article_desc : 'Article Description',om:'OM',soo:'SOO',sit:'SIT',soh:'SOH',mpl:'MPL'};
	this.header_data_type = {article_no : 'number',article_desc : 'char',om:'number',soo:'number',sit:'number',soh:'number',mpl:'number'};
	this.header_row_type = {article_no : 'main',article_desc : 'main',om : 'main',soo : 'main',	sit : 'main',soh:'main',mpl:'main'};
	this.header_class = {article_no : '',article_desc : '',om : '  centerValue ',user : ' centerValue columnDivider  ',soo : ' centerValue  ',sit : '  centerValue   ',soh : ' centerValue  ',mpl : '  centerValue   '	};
	this.header_width = {article_no : '7%',article_desc : '10%',om:'1%',soo:'1%',sit:'1%',soh:'1%',mpl:'1%'};
	this.content_class = {article_no : '',article_desc : '',om : ' centerValue columnDivider  '};
	this.content_format = {article_no : 'removeNull',article_desc : 'removeNull',om:'removeNull',soo:'removeNull',sit:'removeNull',soh:'removeNull',mpl:'removeNull'};
	this.content_width = this.content_format = {article_no : '',article_desc : '',om:'',soo:'',sit:'',soh:'',mpl:''};
