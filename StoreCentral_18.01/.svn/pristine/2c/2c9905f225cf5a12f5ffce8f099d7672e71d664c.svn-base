...
function articleVoid(){
	var data = $('#articleVoidRefund').serialize();
	var articleVoid = '';
	var msg = '';
	var output = '';
	...
	$.ajax({
		...
		success : function(response) {
			...
			articleVoid = output.data;
			
			msg = output.msg;
			
			/*if (msg != undefined && msg!='' && !isNaN(msg) && articleVoid != null) {
				orderListContent(articleVoid);
				showOrderFound();
