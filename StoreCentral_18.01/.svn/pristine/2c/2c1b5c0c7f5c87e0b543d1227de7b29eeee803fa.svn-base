...
<script type="text/javascript"
	src="../../scripts/1POS/script/posConsolidation.js?${properties.CachedCssAndJsFilesVersion}"></script>
<script type="text/javascript"
...
<body>
	...
	<div class="mainWrapper woolworths">
			...
			<div class="breadcrumbWrapper">
				<div class="breadcrumbs">
					...
					<ul>
						...
						<li class="currentPage">POS Consolidation Report</li>
					</ul>
				</div>
				<!-- End of breadcrumbs -->
		...
		<!-- End of head wrapper -->
		<form action="onPageLoad.htm" id="posConsolidation" method="get">
			...
			<div class="contentWrapper reportWrapper">
				...
				<div class="articleAdditionalInfo">
					...
					<div id="accordion">
						...
						<h3 class="mainAccordion">Generate POS Consolidation Report</h3>
						<div>
						...
						<div class="ContentTableWrapper">
							...
							<div class="tableInfo">
								...
								<div class="tableTitle">
									<h4 class="sectionTitle">POS Consolidation Report</h4>
								</div>
								<!-- End of table title -->
