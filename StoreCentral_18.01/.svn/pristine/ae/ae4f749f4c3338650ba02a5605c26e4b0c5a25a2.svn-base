...
<title>In-store Clearance Promotions</title>
...
<script type="text/javascript"
	src="../../scripts/inStore_PromoClearance.js?vertion=${properties.version}"></script>
<script type="text/javascript"
			...
			<div class="breadcrumbWrapper">
				<div class="breadcrumbs">
					...
					<ul>
						...
						<li class="currentPage">Clearance </li>
					</ul>
				</div>
				<!-- End of breadcrumbs -->
					...
					<div class="innerSection">
						<h4 class="sectionTitle">
							<strong>View : </strong> <input type="radio" name="status"
								...
								class="selectOptions" style="min-width: inherit !important;" id="listOption" for="MM"
								>
								<option value="myDrafts">My Drafts</option>
								<option value="allDrafts">All Drafts</option>
							</select> <input type="radio" name="status" value="MF" id="MF" class="${properties.InStorePromotionClearance}">
							<!-- class="${properties.clractive}"applicationSettings CR-->
							<label
								for="MF" class="labelText ${properties.InStorePromotionClearance}">Active &amp; Future
								Promotions</label>
								<!-- class="${properties.clractive}"applicationSettings CR--> 
								<input type="radio" name="status" value="MR" id="MR" class="${properties.InStorePromotionClearance}">
								<!-- class="${properties.clrPast}"applicationSettings CR-->
								<label
								for="MR" class="labelText ${properties.InStorePromotionClearance}">Past Promotions</label>
								<!-- class="${properties.clrPast}"applicationSettings CR-->
						</h4>
...
<form:form id="submitQuery" modelAttribute="InstoreSearchParam">
						...
						<thead id="promoArticleList">
							...
							<tr class="filterRow hideBlock drillsOpenDefault">
								...
								<td class="columnDivider centerValue"><input type="#" style="width:45px"
				...
				<div class="pageActions ${properties.InstoreClearanceCreate} hideBlock" id="beforePublish">
	...
	<div class="pageErrorsWrapper hideBlock temp-fix-pop-up" id="errorWrapper" style="">
		<div class="pageErrorsContent">
			<div class="pageErrorsTitle">
				...
				<a class="close" title="Close">Close</a>
				<p class="description" id="error-message-head">In-Store Clearance creation failed.</p>
			</div>
			<!-- End of quick help title -->
			<div class="content">
