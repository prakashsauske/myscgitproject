...
<script type="text/javascript" src="../../scripts/zeroMPLReport.js?version=${properties.version}"></script>
...
<body>
	<div class="mainWrapper woolworths">
			...
			<div class="breadcrumbWrapper">
				<div class="breadcrumbs">
					...
					<ul>
						...
						<li class="currentPage">Display Zero MPL</li>
					</ul>
				</div>
				<!-- End of breadcrumbs -->
		...
		<!-- End of head wrapper -->
		<form:form name="zeroMPLReport" id="zeroMPLReport"
					...
					<div id="reportContent" class="hideBlock ContentTableWrapper">
						...
						<div class="tableInfo">
							...
							<div class="tableTitle">
								<h4>
									Total <strong>50</strong> articles with Zero MPL
								</h4>
							</div>
							<!-- End of table title -->
