...
function tblReport(table_name,table_title,data){
	...
	this.option = 'build';
	this.key = [ 'article_no','article_desc', 'om', 'soo', 'sit', 'soh','mpl','sugoQty','orderQty' ];
	this.table_name = report_name;
	this.table_title = '';
	this.table_class = ' ContentTable actionRows';
	this.header_tr_class = 'collapsed';
	this.header_name = {article_no : 'Article#',article_desc : 'Article Description',om:'OM',soo:'SOO',sit:'SIT',soh:'SOH',mpl:'MPL',sugoq1:'Qty.1',sugoq2:'Qty.2',orderq1:'Qty.1',orderq2:'Qty.2'};
	this.header_data_type = {article_no : 'number',article_desc : 'char',om:'number',soo:'number',sit:'number',soh:'number',mpl:'number',check:'char',sugoq1:'number',sugoq2:'number',orderq1:'number',orderq2:'number'};
	this.header_row_type = {article_no : 'main',article_desc : 'main',om : 'main',soo : 'main',	sit : 'main',soh:'main',mpl:'main',sugoQty:'sub',orderQty:'sub'};
	this.header_sub_rows = {sugoQty : {subKeys : [ 'sugoq1', 'sugoq2' ]},orderQty : {subKeys : [ 'orderq1', 'orderq2' ]}};
	this.header_class = {article_no : '',article_desc : '',om : '  centerValue ',user : ' centerValue columnDivider  ',sugoQty : ' centerValue columnDivider noSort  ',orderQty : ' centerValue columnDivider noSort  ',soo : ' centerValue  ',sit : '  centerValue   ',soh : ' centerValue  ',mpl : '  centerValue   '	};
	this.header_width = {article_no : '7%',article_desc : '10%',om:'1%',soo:'1%',sit:'1%',soh:'1%',mpl:'1%',sugoq1:'4%',sugoq2:'4%',orderq1:'4%',orderq2:'4%'};
	this.content_class = {article_no : '',article_desc : '',om : ' centerValue columnDivider  ',	sugoQty : ' centerValue columnDivider noSort  ',	orderQty : ' centerValue columnDivider noSort  ',user : ' centerValue  ',sugoq1 : ' centerValue',sugoq2 : ' centerValue',orderq1 : ' centerValue',orderq2 : ' centerValue'};
	this.content_format = {article_no : 'removeNull',article_desc : 'removeNull',om:'removeNull',soo:'removeNull',sit:'removeNull',soh:'removeNull',mpl:'removeNull',sugoq2:'removeNull',orderq1:'removeNull',orderq2:'removeNull'};
	this.content_width = this.content_format = {article_no : '',article_desc : '',om:'',soo:'',sit:'',soh:'',mpl:'',sugoq1:'',sugoq2:'',orderq1:'',orderq2:''};
	this.header_td_label = {sugoQty:'SUGO Qty.',orderQty:'Order Qty.'};
