...
function tblReport(table_name,table_title,data){
	...
	var date1="24/05";	var date2="25/05";var date3="26/05";var date4="27/05";var date5="28/05";
	

	this.option = 'build';
	this.key = [ 'last5DaysStock','article_no','article_desc', 'om', 'soo', 'sit', 'soh','mpl','sugoQty','orderQty' ];
	this.table_name = report_name;
	this.table_title = '';
	this.table_class = ' ContentTable actionRows';
	this.header_tr_class = 'collapsed';
	this.header_name = {article_no : 'Article#',article_desc : 'Article Description',om:'OM',soo:'SOO',sit:'SIT',soh:'SOH',mpl:'MPL',date1:date1,date2:date2,date3:date3,date4:date4,date5:date5,check:'Check',sugoq1:'Qty.1',sugoq2:'Qty.2',orderq1:'Qty.1',orderq2:'Qty.2'};
	this.header_data_type = {article_no : 'number',article_desc : 'char',om:'number',soo:'number',sit:'number',soh:'number',mpl:'number',date1:'number',date2:'number',date3:'number',date4:'number',date5:'number',check:'char',sugoq1:'number',sugoq2:'number',orderq1:'number',orderq2:'number'};
	this.header_row_type = {article_no : 'main',article_desc : 'main',om : 'main',soo : 'main',	sit : 'main',soh:'main',mpl:'main',last5DaysStock:'sub',sugoQty:'sub',orderQty:'sub'};
	this.header_sub_rows = {last5DaysStock : {subKeys : [ 'date1', 'date2', 'date3', 'date4','date5', 'check' ]},sugoQty : {subKeys : [ 'sugoq1', 'sugoq2' ]},orderQty : {subKeys : [ 'orderq1', 'orderq2' ]}};
	this.header_class = {article_no : '',article_desc : '',om : '  centerValue ',user : ' centerValue columnDivider  ',last5DaysStock : ' centerValue columnDivider noSort  ',sugoQty : ' centerValue columnDivider noSort  ',orderQty : ' centerValue columnDivider noSort  ',soo : ' centerValue  ',sit : '  centerValue   ',soh : ' centerValue  ',mpl : '  centerValue   '	};
	this.header_width = {article_no : '7%',article_desc : '10%',om:'1%',soo:'1%',sit:'1%',soh:'1%',mpl:'1%',date1:'1%',date2:'1%',date3:'1%',date4:'1%',date5:'1%',check:'1%',sugoq1:'4%',sugoq2:'4%',orderq1:'4%',orderq2:'4%'};
	this.content_class = {article_no : '',article_desc : '',om : ' centerValue columnDivider  ',	last5DaysStock : ' centerValue columnDivider noSort  ',	sugoQty : ' centerValue columnDivider noSort  ',	orderQty : ' centerValue columnDivider noSort  ',user : ' centerValue  ',sugoq1 : ' centerValue',sugoq2 : ' centerValue',orderq1 : ' centerValue',orderq2 : ' centerValue'};
	this.content_format = {article_no : 'removeNull',article_desc : 'removeNull',om:'removeNull',soo:'removeNull',sit:'removeNull',soh:'removeNull',mpl:'removeNull',date1:'removeNull',date2:'removeNull',date3:'removeNull',date4:'removeNull',date5:'removeNull',check:'removeNull',sugoq1:'removeNull',sugoq2:'removeNull',orderq1:'removeNull',orderq2:'removeNull'};
	this.content_width = this.content_format = {article_no : '',article_desc : '',om:'',soo:'',sit:'',soh:'',mpl:'',date1:'',date2:'',date3:'',date4:'',date5:'',check:'',sugoq1:'',sugoq2:'',orderq1:'',orderq2:''};
	this.header_td_label = {last5DaysStock : 'Last 5 Days Stock Received',sugoQty:'SUGO Qty.',orderQty:'Order Qty.'};
	...
	this.curr_page = 1;
	this.sort = true;
	this.cont_data_function = {check:showCheck};
	this.cont_sort_function = {check:getCheck};
 ...
 */
var showCheck = function(obj){
	var classes;
	if(obj.check == "yes"){
		classes =" success";
	}else if(obj.article_no == ""){
		classes ="";
	}
	var inpu= '<label class="'+classes+'">'+obj.check+'</label>';
	return (inpu);
};
/**
