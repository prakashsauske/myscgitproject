...
function repairAcceptanceNotePrint(){
	startLoading();
	//$('.pageBreak :first').removeClass('pageBreak');
	if($('#salesOrg').val()==1060)
	{
	acceptanceJasperPrint();
	
	}
	else{
	$('#printbodyForAcpNot').children(':first').removeClass('pageBreak');
	$('.siteNoNamePrint').text($('.siteNoName').text());
	$('.currentDate').text(dateformat());
	$('.currentTime').text(timeformat());
	$('.endOfReport').removeClass('hideBlock');
	var a = window.open ();
	$("#printDataForAcpNot").show();
	a.document.write('<script src="../../scripts/jquery-1.9.1.js"></script>'); 
	  a.document.write(document.getElementById('printDataForAcpNot').innerHTML);
	
	$("#printDataForAcpNot").hide();
	a.focus();
	//call print
	$(a).ready(function(){
		 //a.close();   
...
function repairServiceOrderPrint(){
	//$('.pageBreak :first').removeClass('pageBreak');
	if($('#salesOrg').val()==1060 && dangerFlag=="Y"){

		$.fn.warnPopup('warn',leaveScreenMsg,'Dangerous Article Warning',triggerLeaveDangerArticlePopUpPrintYes,triggerLeaveDangerArticlePopUpScreenNo,'',$(this));
	}
	else
	{
		$('#printbodyForSerOdr').children(':first').removeClass('pageBreak');
		$('.siteNoNamePrint').text($('.siteNoName').text());
		$('.currentDate').text(dateformat());
		$('.currentTime').text(timeformat());
		$('.endOfReport').removeClass('hideBlock');
		var a = window.open ();
		$("#printDataForSerOdr").show();
		a.document.write('<script src="../../scripts/jquery-1.9.1.js"></script>'); 
		a.document.write(document.getElementById('printDataForSerOdr').innerHTML);

		$("#printDataForSerOdr").hide();
		a.focus();
		//call print
		$(a).ready(function(){
			//a.close();   
...
var triggerLeaveDangerArticlePopUpPrintYes = function(e)
{
	var $elem = e.data.msg;
	$elem.dialog('close');
	$('#printbodyForSerOdr').children(':first').removeClass('pageBreak');
...
function repairReminderPrint(){
	//$('.pageBreak :first').removeClass('pageBreak');
	
	$('#printbodyForRemLtr').children(':first').removeClass('pageBreak');
	$('.siteNoNamePrint').text($('.siteNoName').text());
	$('.currentDate').text(dateformat());
	$('.currentTime').text(timeformat());
	var a = window.open ();
	$("#printbodyForRemLtr").show();
	a.document.write('<script src="../../scripts/jquery-1.9.1.js"></script>'); 
	  a.document.write(document.getElementById('printbodyForRemLtr').innerHTML);
	
	$("#printbodyForRemLtr").hide();
	a.focus();
	//call print
	$(a).ready(function(){
		 //a.close();   
...
//Repair Carton label
function repairCartonLabelPrint(){
	if($('#salesOrg').val()==1060){
	callCartonLblJasperPrints();
	}
	//$('.pageBreak :first').removeClass('pageBreak');
	else 
	{
	$('#printbodyForCtnLbl').children(':first').removeClass('pageBreak');
	$('.siteNoNamePrint').text($('.siteNoName').text());
	$('.currentDate').text(dateformat());
	$('.currentTime').text(timeformat());
	var a = window.open ();
...
//$('.pageBreak :first').removeClass('pageBreak');
	...
	var lastPageTrLen=0;
	$('.totalPage').text($('.currentPagePrint').length);
	$('.fromDatePrint').text($('#dateFromHide').text()+' '+$('#timeFromHide').val());
	$('.toDatePrint').text($('#dateToHide').text()+' '+$('#timeToHide').val());
...
function markdownDetailsPrint(){
	...
	$('.pageBreak :first').removeClass('pageBreak');
		...
		if($('.seg').text().trim()=="")
			...
			if($('#hiddenArticleNo').val()=='')
				{
				$('.promotionCheck').text('All');
				}
			else
				{
				$('.promotionCheck').text($('#hiddenArticleNo').val());
				}
			...
			if($('#supplier').val()=='')
				...
				{
				$('.supplierCheck').text($('#supplier').val());
				}
		var date=new Date();
		$('.currentDate').text(dateformat());
		$('.currentTime').text(timeformat());
	...
	if(lastPageRows!=0){
		for(var i=0;i<lastPageRows-9;i++){
			if(i!=0)
				...
				$('.printtabledis').last().append("<tr class='dis-end'><td colspan='11'></td></tr>"
						+"<tr class='dis-end'>"
						+"<td colspan='9'></td>"
					...
					+"<tr class='dis-end'>"
						+"<td colspan='9'></td>"
						+"<td colspan='1'>3.Pricing Difference </td>"
						+"<td colspan='1'>PD</td>"
					+"</tr>"
					+"<tr class='dis-end'>"
						+"<td colspan='9'></td>"
					...
					+"</tr>"
					+"<tr>"
						+"<td colspan='9'>Note: Discrepancies/differences must be cleared unless indicated on the report.</td>"
					+"</tr>"
					+"<tr>"
						+"<td style='text-align:center' colspan='11'><strong>End of Report</strong></td>"
					+"</tr>");
				}
			}
		}
			...
			$('#printbody').append(tableLast+tempTr+
					"<tr class='dis-end'><td colspan='11'></td></tr>"
					+"<tr class='dis-end'>"
						+"<td colspan='9'></td>"
						+"<td colspan='1'>ACTION UNDERTAKEN (ACT)</td>"
						+"<td colspan='1'>ABBRV</td>"
					...
					+"<tr>"
						+"<td colspan='9'>Note: Discrepancies/differences must be cleared unless indicated on the report.</td>"
					+"</tr>"+
					"<tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='height40 ><td></td></tr><tr class='dis-end' style='height: 23px !important;'><td colspan='11' style='    padding: 0px;'>"+footer+"</tr></table>");
			//$('.endOfReport:last').removeClass('hideBlock');
		}
	$('.currentDate').text(dateformat());
	$('.currentTime').text(timeformat());	
...
function repairAcceptanceNotePrints(){
	startLoading();
	//$('.pageBreak :first').removeClass('pageBreak');
	...
	if(roleId!='CSD'){
	$('#dialog-cartonCount').find('#cartonCount').val(3);
	$('#dialog-cartonCount').find("#cartonCount").prop('disabled',true);
	$('#dialog-cartonCount').dialog('open');
	$("#dialog-created").dialog("close");
	stopLoading();
	$("#dialog-cartonCount").find('.okButton').unbind('click');
	$("#dialog-cartonCount").find('.okButton').bind("click", (function () {
		var carCount = $("#dialog-cartonCount").find('#cartonCount').val();
		$("#dialog-cartonCount").dialog("close");
	var a = window.open ();	
	var i;
	for(i=1;i<=carCount-1;i++){
	$("#printDataForAcpNot").show();
	a.document.write('<script src="../../scripts/jquery-1.9.1.js"></script>'); 
	  a.document.write(document.getElementById('printDataForAcpNot').innerHTML);	
	$("#printDataForAcpNot").hide();
	...
	a.document.write('<script src="../../scripts/jquery-1.9.1.js"></script>'); 
	  a.document.write(document.getElementById('printDataForAcpNote').innerHTML);	
	$("#printDataForAcpNote").hide();
