...
<title>ALH Financial Data</title>
...
<script type="text/javascript"
	src="../../scripts/1POS/script/ALHFinancialRep.js?${properties.CachedCssAndJsFilesVersion}"></script>
<script type="text/javascript"
...
<body>
	...
	<div class="mainWrapper woolworths">
			...
			<div class="breadcrumbWrapper">
				<div class="breadcrumbs">
					...
					<ul>
						...
						<li class="currentPage">ALH Financial DATA</li>
					</ul>
				</div>
				<!-- End of breadcrumbs -->
		...
		<!-- End of head wrapper -->
		<form action="onPageLoad.htm" id="ALHFinancialData" method="get">
			...
			<div class="contentWrapper reportWrapper">
				...
				<div class="articleAdditionalInfo">
					...
					<div id="accordion">
						...
						<h3 class="mainAccordion">Generate ALH Financial DATA Report</h3>
						<div>
								...
								<div class="formWrapper">
									...
									<div class="parameter">
										<label for="store">Date</label> <input type="#"
											class="textbox defaultTextbox inputDate" id="dateFrom" name="dateFrom"><td> to </td>
											<input type="#"
											class="textbox defaultTextbox inputDate" id="dateTo" name="dateTo">
										<!-- <label id="week" class="week"></label><input type="hidden"
											value="" id="weekYear" /> --> <input type="hidden"
											id="dateFromHide" /> <input type="hidden" id="weekHide" />
										<input type="hidden" id="weekFromDateHide"
											name="weekFromDateHide" /> <input type="hidden"
											id="weekToDateHide" name="weekToDateHide" /> <input
											type="hidden" id="posOperatorType" name="posOperatorType" />
									...
									<div class="parameter parameterRow parameterOptions clearfix">
										...
										<div class="parameter parameterOptionsInputBox">
											...
											<span id="singlePOS"> <input type="#" class="textbox"
												name="userID" id="userID" placeholder="Enter POS ID">
												...
												placeholder="Enter POS ID"> <label class="linkBtn"
												id="verifyAddUser"><label class="advancedSearch">Verify
														& Add</label></label>
...
<input type="hidden" name="hdnPosIds" id="hdnPosIds"/>
						...
						<div class="ContentTableWrapper">
							...
							<div class="tableInfo">
								...
								<div class="tableTitle">
									<h4 class="sectionTitle">ALH Financial Data</h4>
								</div>
								<!-- End of table title -->

								<div class="tableActionBtns">
									<label class="actionBtn" onclick="posConsolidationJasper();"><label
							...
							<table cellspacing="0"
								...
								data-user_id="paginationDivConsol" id="sortTable">
								...
								<thead>
									...
									<tr>
										<th>Tender Type</th>
										<!-- <th class="numberColumn">Opening Loan (+)</th> -->
										<th class="numberColumn">Sales Tender (+)</th>
										<th class="numberColumn">Tender Loan (+)</th>
										<th class="numberColumn">Borrowed Funds (+)</th>
										<th class="numberColumn">Paid In (+)</th>
										<th class="numberColumn">Paid Out (-)</th>
										<th class="numberColumn">Pick Up (-)</th>
										<!-- <th class="numberColumn lastColumn">Expected Funds</th> -->
									</tr>
