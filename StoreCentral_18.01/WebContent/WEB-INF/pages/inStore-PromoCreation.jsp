...
<link href="../../styles/common_new.css?vertion=${properties.version}" rel="stylesheet"filter
	type="text/css" />
...
<script type="text/javascript"
	src="../../scripts/inStore_PromoCreation.js?vertion=${properties.version}"></script>
<%-- <script type="text/javascript"
...
<script type="text/javascript"
	...
	commenting out as its already included in header.jsp --%>
				...
				<div class="ContentTableWrapper">
					...
					<div class="tableInfo">
						...
						<div class="tableTitle">
							<h4 class="sectionTitle">In-store Display Promotion:
							<select
								class="selectOptions" id="listOption" style="min-width: inherit !important;" for="MM">
							...
							<div class="formWrapper">
								...
								<div class="parameter">
									<label for="article" class=" mandatoryFix">Article</label> <input
										type="#" class="textbox articleSearchText searchBox" id="article"
										placeholder="Type number, description, or EAN / TUN / PLU " tabindex="1" name="sr_article">
						...
						<thead><tr>
							...
							<tr class="filterRow hideBlock drillsOpenDefault">
								...
								<td><input type="#" class="textbox inputDate Filter"
									data-filterfor="startDate" placeholder="dd/mm/yyyy" maxlength="10"
									id="startdatefilter"></td>
								<td><input type="#" class="textbox inputDate Filter"
									data-filterfor="endDate" placeholder="dd/mm/yyyy" maxlength="10"
									id="enddatefilter"></td>
								...
								<td data-addonfilter><input type="#"
									...
									<td data-addonfilter><input type="#"
									class="textbox numberBox Filter" data-filterfor="om"></td>
								<td data-addonfilter><input type="#"
								...
								<td class="columnDivider" data-addonfilter><input type="#"
									class="textbox numberBox Filter buildFilter" data-filterfor="build"></td>
								<!--<c:if test="${isbigw==true}">
								...
								<td data-addonfilter class="columnDivider"><input type="#"
									class="textbox inputDate Filter" data-filterfor="deliveryDate" maxlength="10"
	...
	<div class="pageErrorsWrapper hideBlock temp-fix-pop-up" id="errorWrapper" style="">
		<div class="pageErrorsContent">
			<div class="pageErrorsTitle">
				...
				<a class="close" title="Close">Close</a>
				<p class="description">In-Store Display creation failed.</p>
			</div>
			<!-- End of quick help title -->
			<div class="content">
...
<label id="apply" class="actionBtn popupSearchBtn">Apply</label>
			</div>
