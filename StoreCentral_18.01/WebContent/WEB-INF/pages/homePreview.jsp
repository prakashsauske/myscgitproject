...
<body>
	...
	$(document).ready(function() {
		if($('.homeLinkBox').length%3==0)$('.homeBorderHorz').last().remove();
		var i=1;$('.homeLinkBox').each(function(){if(i>3)$(this).addClass('borderBottom');if(i%3==0)$(this).addClass('borderLast').removeClass('borderBottom');i++});
