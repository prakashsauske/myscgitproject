...
<script src="../../scripts/notificationSettingsjWizard.js?version=${properties.version}"></script>
<script type="text/javascript" src="../../scripts/notification.js?version=${properties.version}"></script>
<script type="text/javascript" src="../../scripts/inStore_PromoCreationUtils.js?version=${properties.version}"></script>
	...
	<div class="mainWrapper">
			...
			<div class="breadcrumbWrapper">
				<div class="breadcrumbs">
					...
					<ul>
						...
						<li class="currentPage">Notification Settings</li>
					</ul>
				</div>
				<!-- End of breadcrumbs -->
		...
		<div class="contentWrapper directContent settings">
			...
			<div class="ContentTableWrapper">
				...
				<div id="platform-tab">
					<ul class="ui-tabs-sales-org hideBlock">
								...
								<c:forEach items="${roleList}" var="roleList">
									<c:if test="${salesOrgMap.key==roleList.salesOrg}">
										...
										<div id="edittabs-BW-${salesOrgMap.key}-${roleList.code}"
											...
											<div class="tableTitle">
												<h4>
													<span class="step-count">3</span> <label>Select Notifications & Apply Settings</label>
													<div class="icon-arrow-down">&nbsp;</div>
												</h4>
											</div>
