<div id="dialog-verify" title="Verify User">
	<div class="popupContent">
		...
		<div class="popupActionsWrapper hideBlock">
			<span class="popupActions"> <label class="secondaryActionBtn" onclick="$('#dialog-verify').dialog('close');">Cancel</label>
				<label class="actionBtn add-list">Add to List</label>
