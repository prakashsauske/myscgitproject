		...
		<div class="contentWrapper">
			...
			<div class="articleHead">
				...
				<div class="articleHeaderWrapper">
					<h2 class="articleTitle">Claim #11</h2>					
				</div>
				<div class="articleActionBtns">
					<label class="orderStatus">Status: <strong>Finalised</strong></label>	
<label class="actionBtn" id=""><a href="#"><label class="print">Print</a></label>						
				</div>
				...
				<div class="articleInfoWrapper">				
					<p class="secondaryInfo">
						...
						<label class="articlePriceLabel">|</label>
						<label class="articlePriceLabel">Submitted By: <strong>James Smith</strong></label>
						<label class="articlePriceLabel">|</label>
						<label class="articlePriceLabel">Submitted Date: <strong>25/12/2014</strong></label>
...
<td class="centerValue ">EA</td>						
				...
				<div class="tableActionsWrapper" id="tableAddAction">
					...
					<form method="POST" action="" id="articleForm">
						<div class="formWrapper">
							...
							<div class="parameter">
								<label class="" for="qty">Order Qty.</label>
								<input type="#" tabindex="2" id="qty" class="textbox  numberBox">
								
							</div>
							
							<div class="parameter">
								<label class="" for="delDate">Reason</label>
								<select class="selectOptions supplyDrop">
												<option>Select Reason</option>
												<option>OUT OF DATE (IN)</option>
												<option>CYCLIC COUNT (POSITIVE)</option>
												<option>REVERSE PILFERAGE</option>
												<option>REVERSE STOCK WRITE-OFF</option>
												<option>STOCK TAKE ADJUSTMENT (POSITIVE)</option>
												<option>TRANSFER OVER SUPPLY</option>
											</select>
							</div>
	...
	<script>	
		...
		$('#editAction').click(function(){
			$("#editMode").removeClass('hideBlock');
			$("#viewMode").addClass('hideBlock');
		...
		$('#editMode .pageActions label').click(function(){
			$("#editMode").addClass('hideBlock');
			$("#viewMode").removeClass('hideBlock');	
